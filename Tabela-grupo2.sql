...
GENERATED ALWAYS AS (custo_recuperacao_ha/meses_recuperacao) STORED,
prejuizo_estimado_ha DECIMAL (12,2) 
GENERATED ALWAYS AS (
lucro_mensal_medio_ha * meses_recuperacao + custo_recuperacao_ha) STORED
);

ALTER TABLE custos_recuperacao 
MODIFY COLUMN custo_mensal_estimado DECIMAL(12,2)
GENERATED ALWAYS AS (
ROUND(custo_recuperacao_ha / NULLIF(meses_recuperacao,0),2)) STORED;
...
INSERT INTO arduino (umidade) VALUES
(45.02),
(47.22),
(50.32),
(30.00);
